...
<body>
    <div class="container">
        <h1>Funciones Del Dia</h1>
        <div class="row">
            <div class="col-6">
                <div class="btn-group" role="group" aria-label="Basic example">
                    <button class="btn btn-primary" onclick="window.location.href='registro_funciones.php';">Nueva funcion</button>
                </div>
            </div>
            <div class="col-6">
            </div>
                ...
                <tbody>
                    <?php for ($i = 0; $i < count($arr); $i++) { ?>
                        <tr>
                            ...
                            <td><?php echo $arr[$i]['codigo_pelicula'] ?></td>
                            <td><?php echo $arr[$i]['codigo_sala'] ?></td>
                            <td>
